...
if __name__ == "__main__":
    ...
    genders = [["he", "him", "his"], ["she", "her"], ["they", "them", "their"]]
    genderEM = GenderEM(
        outfile=outfile, entityFiles=ent_files, tokenFiles=tok_files, hyperparameterFile=hyperparams, genders=genders
    )
