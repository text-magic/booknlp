...
def main():
    ...
    parser.add_argument(
        "--model", choices=["small", "big"], default="small", help="Model size to use (big for higher accuracy)"
    )
    parser.add_argument(
        "--pipeline", default="entity,quote,supersense,event,coref", help="Pipeline components to run (comma-separated)"
    )
